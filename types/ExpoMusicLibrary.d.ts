declare module "ExpoMusicLibrary" {
  // ========== Types ==========
  ...
  /**
   * Native module for accessing device music library
   */
  ...
  const ExpoMusicLibrary: ExpoMusicLibraryModule;
...
declare global {
  namespace ReactNative {
    interface NativeModulesStatic {
      ExpoMusicLibrary: import("ExpoMusicLibrary").default;
    }
  }
}