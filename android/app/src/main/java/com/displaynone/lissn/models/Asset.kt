package com.displaynone.lissn.models
...
class Asset (
        ...
        private val albumId: String, // Now contains album name
        private val originalAlbumId: String, // Contains original album ID
    ...
    fun toBundle() = Bundle().apply {
        ...
        putString("albumId", albumId) // Album name for consistency
        putString("originalAlbumId", originalAlbumId) // Original album ID for reference
